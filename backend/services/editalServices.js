...
async function criarEditalService(dados, idUsuario) {
  ...
  if ((!dados.imagem || dados.imagem.length === 0) && dados.categoria) {
    ...
    const imagePath = `http://vm-cinboraimpactar2.cin.ufpe.br/cinscreveback/assets/default_covers/${fileName}`;
    ...
    const imagePath = `http://vm-cinboraimpactar2.cin.ufpe.br/cinscreveback/assets/default_covers/${defaultImages['Outros']}`;
    dados.imagem = [imagePath];
  }
