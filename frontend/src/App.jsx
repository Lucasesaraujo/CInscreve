...
import FavoritarButton from './components/botao_dinamico';
    ...
    <div className="p-8">
      ...
      <Button
        ...
        >
          ...
          Busque
          <span className="text-xs">Encontre editais para transformar sua organização.</span>
        </Button>
      <div className="flex flex-wrap gap-2 mt-8 ">  
        ...
        <FavoritarButton tipo="corpo" tamanho={16} peso="medium" />
